...
public final class Crucible extends RebarBlock implements
    ...
    public static final Map<Material, Integer> VANILLA_BLOCK_HEAT_MAP = getSettings(PylonKeys.CRUCIBLE).getOrThrow("vanilla-block-heat-map", ConfigAdapter.MAP.from(ConfigAdapter.MATERIAL, ConfigAdapter.INTEGER));
